      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2 relative z-20">
          ...
          <Button 
            ...
            size="sm"
            className="w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-zinc-900 font-bold text-white shadow-lg shadow-zinc-900/10 transition-all hover:bg-[#e41e26] hover:shadow-red-500/20 active:scale-95 dark:bg-white dark:text-zinc-900 dark:hover:bg-[#e41e26] dark:hover:text-white"
