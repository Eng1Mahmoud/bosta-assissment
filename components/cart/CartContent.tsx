  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
      ...
      <div className="lg:col-span-2 space-y-3 sm:space-y-4">
        {cart.map((item) => (
          <Card key={item.id} className="overflow-hidden border-zinc-200 dark:border-zinc-800 dark:bg-zinc-900/40 rounded-xl sm:rounded-2xl backdrop-blur-sm">
              ...
              <div className="flex-1 min-w-0 flex flex-col gap-2">
                <div className="flex justify-between items-start gap-2 mb-1">
                  ...
                  <Button 
                    ...
                    className="h-7 w-7 sm:h-8 sm:w-8 text-zinc-400 hover:bg-red-500 hover:text-white transition-all rounded-lg flex-shrink-0"
                  >
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 mt-auto pt-1">
                  <span className="font-black text-base sm:text-lg text-[#e41e26]">${item.price.toFixed(2)}</span>
                  
                  <div className="flex items-center gap-2 bg-zinc-100 dark:bg-zinc-800/50 p-1 rounded-lg w-full sm:w-auto justify-center">
                    <button 
      ...
      <div className="lg:col-span-1">
        <Card className="border-none bg-zinc-900 dark:bg-zinc-800 text-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 sticky top-20 sm:top-24">
          ...
          <Link href="/products" className="flex items-center justify-center gap-2 mt-4 sm:mt-6 text-xs sm:text-sm text-zinc-400 hover:text-white transition-colors">
          ...
          <Button 
            ...
            size="sm" 
            onClick={clearCart}
            className="w-full mt-3 sm:mt-4 text-xs sm:text-sm text-zinc-500 hover:bg-red-500 hover:text-white hover:border-red-500 transition-colors rounded-lg sm:rounded-xl font-bold"
          >
            Clear Cart
          </Button>
        </Card>
