...
export const metadata: Metadata = {
  title: "Home",
  description:
    "Experience the fastest and most reliable e-commerce shopping in Egypt with BostaShop.",
};
        ...
        <div className="relative z-10 container mx-auto px-6">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-lg md:text-2xl text-muted-foreground leading-relaxed max-w-3xl mb-10 md:mb-14 font-medium">
              Unlock a world of quality products delivered through Egypt&apos;s
              most reliable logistics network. Experience the Bosta speed today.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full sm:w-auto">
              ...
              <Link href="/products/create" className="w-full sm:w-auto">
                <Button
                  variant="outline"
                  className="w-full sm:w-auto h-16 md:h-20 px-8 md:px-12 text-lg md:text-xl font-black border-2 border-border rounded-2xl md:rounded-3xl hover:bg-muted hover:!text-black dark:hover:!text-white transition-all hover:scale-105 active:scale-95"
                >
                  Join as Seller
                </Button>
              </Link>
            ...
            <div className="mt-10 pt-10 border-t border-border w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
              <div className="p-4 md:p-0">
                <p className="text-4xl font-black text-foreground mb-1 font-mono">
                  2M+
                </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 md:mb-20">
            ...
            <p className="text-muted-foreground font-medium">
              We bridge the gap between excellence and convenience.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div
                key={i}
                className="group p-8 md:p-10 bg-card rounded-[2rem] md:rounded-[2.5rem] border border-border shadow-sm transition-all hover:shadow-xl hover:-translate-y-2"
              >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 text-center md:text-left">
              <div>
                <h2 className="text-3xl md:text-6xl font-black text-primary-foreground mb-4 md:mb-6 leading-tight">
                  Ready to upgrade <br className="hidden md:block" /> your
                  lifestyle?
                </h2>
                <p className="text-primary-foreground/80 text-lg md:text-xl font-medium max-w-md mx-auto md:mx-0">
                  Join millions of satisfied customers across Egypt. Get the
                  best items at the best prices.
                </p>
              </div>
              <Link href="/products" className="w-full md:w-auto">
                <Button
                  size="lg"
                  className="h-16 md:h-20 w-full md:w-auto px-10 md:px-12 bg-background text-primary hover:bg-muted text-lg md:text-2xl font-black rounded-2xl md:rounded-3xl shadow-xl transition-all hover:scale-105 active:scale-95"
                >
                  Start Exploring
                </Button>
              </Link>
