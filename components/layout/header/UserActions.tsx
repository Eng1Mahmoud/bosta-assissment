     ...
     <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
        ...
        {user && (
            ...
            <Button
                variant="ghost"
                size="icon"
                className="h-10 w-10 rounded-lg text-zinc-600 dark:text-zinc-400 hover:text-[#e41e26] dark:hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-950/20 transition-colors group"
            >
