...
<header className="p-4 sm:p-8 relative z-10 flex justify-end">
				<Link href="/">
					<Button variant="ghost" className="gap-2 text-zinc-500 hover:bg-[#e41e26] hover:text-white transition-colors rounded-xl dark:text-zinc-400 dark:hover:bg-red-600">
