        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div key={i} className="group p-8 md:p-10 bg-white rounded-[2rem] md:rounded-[2.5rem] border border-zinc-100 shadow-sm transition-all hover:shadow-xl hover:-translate-y-2 dark:bg-zinc-900 dark:border-zinc-800">
                <div className="h-14 w-14 md:h-16 md:w-16 bg-red-50 rounded-2xl flex items-center justify-center mb-6 md:mb-8 transition-transform group-hover:scale-110 group-hover:rotate-3 dark:bg-red-950/30">
                  <feature.icon className="h-7 w-7 md:h-8 md:w-8 text-[#e41e26]" />
                </div>
                <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-zinc-900 dark:text-white">{feature.title}</h3>
                <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed font-medium text-sm md:text-base">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="bg-[#e41e26] rounded-[2rem] md:rounded-[3rem] p-8 sm:p-12 md:p-24 relative overflow-hidden shadow-2xl shadow-red-500/20">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 text-center md:text-left">
              <div>
                ...
                <p className="text-red-100 text-lg md:text-xl font-medium max-w-md opacity-90 mx-auto md:mx-0">
              ...
              <Link href="/products" className="w-full md:w-auto">
                <Button size="lg" className="h-16 md:h-20 w-full md:w-auto px-10 md:px-12 bg-white text-[#e41e26] hover:bg-zinc-100 text-lg md:text-2xl font-black rounded-2xl md:rounded-3xl shadow-xl transition-all hover:scale-105 active:scale-95">
                  Start Exploring
                </Button>
              </Link>
            </div>
