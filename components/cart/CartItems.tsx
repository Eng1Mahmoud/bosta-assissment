    ...
    <div className="space-y-3 sm:space-y-4">
      {cart.map((item) => {
        ...
        return (
          <Card
            key={item.id}
            className="overflow-hidden border-border bg-card/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-sm hover:shadow-md transition-all cursor-pointer group"
          >
